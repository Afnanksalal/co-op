...
9. Confirm production CORS origins are restricted.
10. Confirm `LICENSE_KEY_PEPPER` is strong and not reused from development.
11. Clean generated folders that should not be committed.
