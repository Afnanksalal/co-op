      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field
            label="Scenario"
            value={capTable.name}
            onChange={(name) => onCapTableChange({ ...capTable, name })}
          />
          <Field
            ...
            onChange={(value) =>
              onCapTableChange({ ...capTable, postMoneyValuation: Number(value) })
            }
          />
          <Field
            label="Founder %"
            ...
            onChange={(value) =>
              onCapTableChange({ ...capTable, founderOwnershipPercent: Number(value) })
            }
          />
          <Field
            label="Investor %"
            ...
            onChange={(value) =>
              onCapTableChange({ ...capTable, investorOwnershipPercent: Number(value) })
            }
          />
          <Field
            label="Option pool %"
            ...
            onChange={(value) =>
              onCapTableChange({ ...capTable, optionPoolPercent: Number(value) })
            }
          />
        </div>
        <TextArea
          ...
          onChange={(notes) => onCapTableChange({ ...capTable, notes })}
        />
