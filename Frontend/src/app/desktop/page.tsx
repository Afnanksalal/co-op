    ...
    <div className="grid max-w-3xl gap-6 2xl:max-w-none 2xl:grid-cols-[minmax(0,1fr)_minmax(340px,0.75fr)]">
      <section className="order-2 min-w-0 rounded-lg border border-border bg-card p-5 2xl:order-1">
        ...
        <div className="mt-4 space-y-3 text-sm">
          ...
          <Row label="Cloud URL" value={state?.activation?.cloudBaseUrl ?? cloudBaseUrl} />
          <Row
            label="Offline grace"
      ...
      <form onSubmit={onActivate} className="order-1 min-w-0 rounded-lg border border-border bg-card p-5 2xl:order-2">
        ...
        <div className="grid gap-4">
          <Field label="Cloud license URL" value={cloudBaseUrl} onChange={onCloudBaseUrlChange} />
          <Field label="Account email" value={email} type="email" onChange={onEmailChange} />
          <Field label="License key" value={licenseKey} placeholder="COOP-XXXX-XXXX-XXXX-XXXX-XXXX-XXXX" onChange={onLicenseKeyChange} />
          <Field label="Device name" value={deviceName} placeholder="Finance laptop" onChange={onDeviceNameChange} />
        </div>
        <Button type="submit" className="mt-5" disabled={!runtimeAvailable || busyAction === 'activate'}>
