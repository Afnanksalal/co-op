...
export function canonicalLicenseKey(value: string): string {
...
export function licensePrefix(value: string): string {
  const formatted = isValidLicenseKey(value) ? canonicalLicenseKey(value) : value;
